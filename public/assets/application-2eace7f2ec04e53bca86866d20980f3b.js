...
(function() {
  ...
  Browse = {
    init: function() {
      ...
      return $('body').on('keyup', '#service-search-name', this.filterResults);
    },
    ...
    showResults: function(event, data) {
      return $('.service-options').html(data);
    },
...
(function() {
  ...
  Dashboard = {
    init: function() {
      ...
      $('body').on('submit', '.edit_event', this.checkFields);
      $('body').on('touchstart', '#event_start_date, #event_expiration', this.convertEventDate);
      $('body').on('touchstart', '#event_start_time, #event_end_time', this.convertEventTime);
      $('body').on('click', '.ongoing-tab', this.showOngoing);
      $('body').on('click', '.reserved-tab', this.showReserved);
      return this.showOngoing();
    },
    showOngoing: function() {
      $('.event').show();
      return $('.event.reserved').hide();
    },
    showReserved: function() {
      $('.event').hide();
      return $('.event.reserved').show();
    },
    ...
    checkFields: function() {
      ...
      if (name === "" || sd === "" || st === "" || et === "" || th === "") {
        ...
        if (exp === "") {
          $('#event_expiration').css('border', '1px solid red');
        }
        return false;
      } else {
        return true;
