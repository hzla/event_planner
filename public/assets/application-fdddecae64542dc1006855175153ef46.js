...
(function() {
  ...
  NewEvent = {
    init: function() {
      $('.date-type').click(this.toggleEventDateForm);
    ...
    cancelChoice: function() {
      ...
      return NewEvent.reassignNumbers();
    },
    addChoice: function() {
      ...
      nextChoice = "<div class='text-choice placeholder'> <div class='text-choice-num'>" + nextChoiceNum + ".</div> <input class='text-choice-input' id='text_choice_" + nextChoiceNum + "' name='text_choice_" + nextChoiceNum + "' type='text'> </div>";
    ...
    confirmEventDetails: function() {
      var currentQuestion, dates;
      currentQuestion = $('.question-info-container.active');
      if (currentQuestion.find('.poll-field').val() === "") {
        return currentQuestion.find('.poll-field').css('border', '1px solid red');
      } else {
    ...
    toggleEventDateForm: function() {
      return $('#datepicker, .bottom-btn-container, .type-container').toggle();
    },
    ...
    clearEventDetails: function() {
      $('#datepicker').datepicker('remove');
      NewEvent.initDatePicker();
      return NewEvent.closeEventForm();
    }
  };
