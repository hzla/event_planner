...
(function() {
  var SimpleDateTextPicker, ready;
  ...
  ready = function() {
    return SimpleDateTextPicker.init();
  };
...
(function() {
  ...
  SimpleNewEvent = {
    init: function() {
      ...
      $('body').on('click', '#poll-url-container', this.dontHideEventUrl);
      ...
      if ($(window).width() > 1023) {
        ...
        $('#datepicker, #datepicker-2').datepicker().on('clearDate', this.clearDate);
        return this.dateChangable = true;
      }
    },
    hideEventUrl: function() {
      return $(this).hide();
    },
    dontHideEventUrl: function(e) {
    ...
    showEventUrl: function(e, data) {
      ...
      $('#poll-url-container').append("<a href='" + pollTakeUrl + "'> <div id='take-poll-btn' class='btn blue-btn'>Take Poll</div> </a>");
      $('#poll-url')[0].select();
      $('.submit-simple-event').addClass('inactive');
      return $('#simple-event-btns').append("<a href='" + pollTakeUrl + "'> <div class='btn blue-btn btn-bot'>Take Poll</div> </a>");
    },
    showDelete: function() {
    ...
    nextTypeOnTab: function(e) {
      if (e.keyCode === 9 && $('.type').first().hasClass('selected')) {
        ...
        return $('#main-header a').click(function() {
          return false;
        });
      } else if (e.keyCode === 9 && $('.type').last().hasClass('selected')) {
        $('.selected').removeClass('selected');
        return $('.type').first().addClass('selected');
      }
    },
    selectTypeOnTab: function(e) {
      ...
      if (e.keyCode === 9) {
        ...
        $('.selected').removeClass('selected');
        return toSelect.first().addClass('selected');
      }
    },
    sortable: function() {
      var choices, list;
    ...
    addChoiceWithClick: function() {
      ...
      nextChoice = "<div class='text-choice placeholder'> <div class='draggable-container'> <div class='draggable-top'></div> <div class='draggable-bottom'></div> <div class='text-choice-num'>" + (String.fromCharCode(nextChoiceNum + 96)) + ".</div> </div> <input class='text-choice-input' id='text_choice_" + nextChoiceNum + "' name='text_choice_" + nextChoiceNum + "' type='text' placeholder='Add Option...'> </div>";
    ...
    editDateQuestion: function(clickedQuestion) {
      ...
      if ($('#text-choice-picker:visible, .date-picker-container:visible, .type-container:visible').length < 1) {
        ...
        $('#datepicker, #datepicker-2').datepicker('setDates', parsedDates);
        $('#datepicker .day').first().click().click();
    ...
    confirmEventDetails: function() {
      var currentQuestion, dates, showTypePicker;
