...
(function() {
  ...
  Home = {
    init: function() {
      ...
      this.halfHeight = $(window).height() / 2;
      this.threeHalfHeight = this.halfHeight * 3;
      this.trigger = false;
      return $('.phone-info-item').click(this.showActive);
    },
    showActive: function() {
    ...
    fadeElements: function() {
      var currentHeight, fade1, fade2, fade3;
      ...
      if (currentHeight < (Home.height * 3) - 5) {
        ...
        return $('.fade-3').css('opacity', fade3);
      } else {
        if (Home.trigger === false) {
          Home.trigger = true;
          setTimeout(function() {
            return Home.trigger = false;
          }, 1000);
          return Home.showcasePhone();
        }
      }
    },
    showcasePhone: function() {
      var next;
      if ($('.phone-info-item.active').length < 1) {
        return $('.phone-info-item').first().addClass('active');
      } else {
        console.log("done");
        next = $('.active').next();
        $('.active').removeClass('active');
        ...
        if (next.length < 1) {
          return $('#get-started-button').show().addClass('animated fadeIn');
        }
      }
    }
  };
