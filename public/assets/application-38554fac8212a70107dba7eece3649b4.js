    ...
    showTypePicker: function() {
      ...
      if (SimpleNewEvent.shown === false) {
        ...
        $('.type-container').animate({
          ...
          return $('#poll-creator, #simple-events-form').scrollTop(100000);
        });
