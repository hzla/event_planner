...
(function() {
  ...
  SimpleNewEvent = {
    init: function() {
      ...
      $('body').on('click', '.text-choice.placeholder', this.addChoice);
    ...
    editDateQuestion: function() {
      ...
      if ($('#text-choice-picker:visible, #datepicker-container:visible, .type-container:visible').length < 1) {
        ...
        return $('.date-picker-container, #simple-event-btns').show();
      }
    },
    ...
    addChoice: function() {
      ...
      nextChoice = "<div class='text-choice placeholder'> <div class='text-choice-num'>" + nextChoiceNum + ".</div> <input class='text-choice-input' id='text_choice_" + nextChoiceNum + "' name='text_choice_" + nextChoiceNum + "' type='text' placeholder='Add Option...'> </div>";
    ...
    toggleEventDateForm: function() {
      ...
      if (currentQuestion.val() !== "") {
        return $('.date-picker-container, #simple-event-btns, .type-container').toggle();
      } else {
