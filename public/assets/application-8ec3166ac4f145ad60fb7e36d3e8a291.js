...
(function() {
  ...
  Browse = {
    init: function() {
      ...
      $('body').on('click', '.chosen.service-tab', this.showChosenOptions);
      $('body').on('click', '.browse.service-tab', this.showAllOptions);
      $('body').on('click', '.service-tab', this.toggleActive);
      return $('body').on('click', '.submit-options', this.submitOptions);
    },
...
(function() {
  ...
  Dashboard = {
    init: function() {
      ...
      $('body').on('click', '#cancel-form', this.hidePollForm);
      return $('body').on('submit', '#new_event', this.checkFields);
    },
