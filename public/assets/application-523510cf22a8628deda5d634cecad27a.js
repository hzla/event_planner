...
(function() {
  ...
  Browse = {
    ...
    showResults: function(event, data) {
      return $('.service-options.choosable').html(data);
    },
    ...
    showChosenOptions: function() {
      ...
      return $('.selected-options').show();
    },
    showAllOptions: function() {
      $('.service-options').show();
      return $('.selected-options').hide();
    },
...
(function() {
  ...
  Dashboard = {
    ...
    slideTime: function(value) {
      var hours0, minutes0, time;
      minutes0 = parseInt(value % 60, 10);
      hours0 = parseInt(value / 60 % 24, 10);
      return time = Dashboard.getTime(hours0, minutes0);
    },
  ...
  Home = {
    ...
    fadeElements: function() {
      ...
      if (currentHeight > (Home.height - 80)) {
        return $('.header-link').css('color', 'black');
      } else {
        return $('.header-link').attr('style', '');
      }
    }
  };
...
(function() {
  ...
  NewEvent = {
    init: function() {
      ...
      return $('#event_threshold').change(this.showNextArrow);
    },
    finishTut: function() {
