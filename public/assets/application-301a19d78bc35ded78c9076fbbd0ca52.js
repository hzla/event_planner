...
(function() {
  ...
  SimpleNewEvent = {
    init: function() {
      ...
      $('body').on('keydown', '.text-choice-input', this.nextOnEnter);
      $('body').on('keydown', this.confirmDateOnEnter);
      $('body').on('keydown', '.active .poll-field', this.showTypePicker);
      if ($(window).width() < 1023) {
        $('body').on('focus', '.text-choice-input', this.hideBtns);
        $('body').on('unfocus blur', '.text-choice-input', this.showBtns);
      }
    ...
    cancelTypeContainer: function(e) {
    ...
    editDateQuestion: function(clickedQuestion) {
      ...
      return $('#poll-creator')[0].scrollTop = 100000;
    },
    ...
    addChoice: function() {
      ...
      return $('#text-choice-picker')[0].scrollTop = 100000;
    },
    ...
    confirmEventDetails: function() {
      ...
      if ($('.date-picker-container:visible').length > 0) {
        ...
        if (dates.length < 2) {
          ...
          setTimeout(function() {
            return $('.date-picker-container').css('border', 'none');
          }, 1000);
          return;
        }
        ...
        if ($('#text_choice_1').val() === "" || $('#text_choice_2').val() === "") {
          ...
          setTimeout(function() {
            return $('.text-choice-input').css('border', '1px solid lightgrey');
          }, 1000);
          return;
        }
    ...
    toggleEventTextForm: function() {
      ...
      if (currentQuestion.val() !== "") {
        ...
        $('#poll-creator')[0].scrollTop = 100000;
        return $('.text-choice-input').first().focus();
      } else {
        currentQuestion.css('border', '1px solid red');
        $('input.poll-field').last().focus();
        return setTimeout(function() {
